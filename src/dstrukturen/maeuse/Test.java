...
public class Test {
    public static void main(String[] args) {
        ...
        Kampf k = new Kampf();
        k.zufallsBelegung(5);
        k.kampfAusfuehren(); // Kampf wird mit zufällligen Stärken getestet

        int[] arr1 = { 7, 6, 5, 4, 3, 2, 8, 9, 1 }; // Ja
        k.reihenfolgeSimulieren(arr1);
        int[] arr2 = { 1, 3, 4, 6, 7, 10, 9, 11, 12, 8, 5, 2 }; // Ja
        k.reihenfolgeSimulieren(arr2);
        int[] arr3 = { 4, 5, 3, 1, 2, 6 }; // Nein
        k.reihenfolgeSimulieren(arr3); // Eine vorgegebene Reihenfolge wird getestet/simuliert
